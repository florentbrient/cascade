...
def compute_spectral_transfer(U, V, W, dx=50.0, dy=50.0, dz=10.0,
    ...
    k,kk1,kk2,kk3,kk4,kk5 = [None for ij in range(6)]
    PI_k, PI_hh, PI_hv, PI_vh, PI_vv = [None for ij in range(5)]
    PI_3D, PI_h, PI_g, PI_hz, PI_hz5 = [None for ij in range(5)]
...
#                                             dx=dx,dy=dy,dz=dz,filter_type='spectral_hz')
        kk5, PI_hz5,  *_ = compute_Pi_from_uBF_corrected(U, V, W, N_u, N_v, N_w,  
                                             kk=kk1,
                                             w_bc='dst',
                                             dx=dx,dy=dy,dz=dz,filter_type='spectral_hz')
...
def compute_Pi_from_uBF_corrected(U, V, W, N_u, N_v, N_w,
                         scalar=None,
                         Nhh=None, Nhv=None,
                         Nvh=None, Nvv=None,
                         kk=None, dx=1.0, dy=1.0, dz=1.0,
